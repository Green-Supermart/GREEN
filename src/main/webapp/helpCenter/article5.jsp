<%-- 
    Document   : article5
    Created on : 23 Dec 2023, 14:04:15
    Author     : Sandun
--%>
...
<html>
    <head>
        ...
        <title>Article 5 - Help Center | GREEN Supermart</title>
            ...
            <div class="container">
                ...
                <div class="flex flexCol" style="gap: 40px;">
                    ...
                    <div class="breadcrumb flex flexRow" style="gap: 10px; font-size: 14px; align-items: center;">
                        ...
                        <span class="currentLink">Article 5 Heading</span>
                    </div>
                    
                    <h1 style="color: #1DA31A; text-align: center; margin-bottom: 30px; font-size: 34px; font-weight: 400;">Article 5 Heading</h1>

                ...
                <div class="pageTopic flex">
                    <div class="pageTopicContainer flex flexRow">
                        ...
                        <span class="flex flexRow" style="gap: 10px;">
                                    <span class="addIcon flex" onclick="window.location.href='products/new.jsp'" title="New Product">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                    <span class="entryActionIcons flex flexRow" style="gap: 10px;">
                                                        <a href="products/update.jsp?id=<%= id %>" style="text-decoration: none;"><span class="flex"><i class="fa-solid fa-pen"></i></span></a>
                                                        <a href="/DeleteProductServlet?id=<%= id %>" style="text-decoration: none;"><span class="flex"><i class="fa-solid fa-trash-can"></i></span></a>
                                                    </span>
                                        </td>
                                    </tr>

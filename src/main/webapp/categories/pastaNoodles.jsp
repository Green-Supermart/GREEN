<%-- 
    Document   : pastaNoodles
    Created on : 10 Dec 2023, 17:15:47
    Author     : Sandun
--%>
...
<html>
    <head>
        ...
        <title>Pasta and Noodles | GREEN Supermart</title>
        ...
        <script>
            ...
            fetch('/getProductDetails')
                ...
                .then(data => {
                    ...
                    const fruits = data.filter(product => product.category === 'Pasta and Noodles');

<%-- 
    Document   : vegetables
    Created on : 10 Dec 2023, 16:34:39
    Author     : Sandun
--%>
...
<html>
    <head>
        ...
        <title>Vegetables | GREEN Supermart</title>
    ...
    <body>
        ...
        <script>
            ...
            fetch('/getProductDetails')
                ...
                .then(data => {
                    const fruits = data.filter(product => product.category === 'Vegetables');
                    ...
                    fruits.forEach(product => {
                        ...
                        const productCard =
                            ...
                            `<div class="productCard flex flexCol" style="width: 275px; height: 425px;">
                                ...
                                <div class="productContent flex flexCol" onclick="addToWishlist(`+id+`)">
                                    <h1>
